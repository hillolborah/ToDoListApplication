...
void MainFrame::BindEventHandlers()
{
	...
	this->Bind(wxEVT_CLOSE_WINDOW, &MainFrame::OnWindowCosed, this);
}
...
void MainFrame::OnClearButtonClicked(wxCommandEvent& evt)
{
	...
	wxMessageDialog dialog(this, "Clear Tasks?", "Clear", wxYES_NO | wxCANCEL);
...
void MainFrame::OnWindowCosed(wxCloseEvent& evt)
{
